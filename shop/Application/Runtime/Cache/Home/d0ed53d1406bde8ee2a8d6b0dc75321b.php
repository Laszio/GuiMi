                ...
                <div class="uc-panel">
                    ...
                    <div class="uc-panel-bd">
                        ...
                        <table class="refund-returns-list">
                            ...
                            <?php if(is_array($dataInfo)): foreach($dataInfo as $key=>$v): ?><tr class="item-head">
                                    <td colspan="5">
                                        <div class="fl">
                                            退款编号: <?php echo ($v['id']); ?> <span class="ml15">
                                        </div>
                                        <div class="fr">申请时间：<?php echo ($v['addtime']); ?>   </div>
                                    </td>
                                </tr>
                                <tr class="item">
                                    <td class="first">
                                        <div class="good-desc">
                                            <img class="gimg" src="/Uploads<?php echo ($v['colorpic']); ?>" alt="" />
                                            <div class="ginfo">
                                                <?php echo ($v['gname']); ?><br />订单编号：<?php echo ($v['oid']); ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="text-danger"><?php echo ($v['money']); ?>元</span></td>
                                    <td><?php echo ($v['status']); ?></td>
                                    <td class="last"></td>
                                </tr>
                                <tr class="blank"></tr><?php endforeach; endif; ?>
                        </table>
                    </div>
                </div>
            </div>
