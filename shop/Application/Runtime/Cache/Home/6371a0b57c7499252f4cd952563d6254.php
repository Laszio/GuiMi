                            ...
                            <form action="" enctype="multipart/form-data" method="post" id="testForm">
                                ...
                                <div class="col-headpic">
                                    <div class="pic-wrap">
                                        ...
                                        <div class="picbox">
                                            <img src="/Uploads<?php echo ($info['user_img']); ?>" style="width:125px" alt="" />
                                        </div>
                                        <label>
                                            <a class="edit">修改头像</a>
                                ...
                                <div class="col-userinfo">
                                    <div class="control-group">
                                        ...
                                        <div class="bd"><a class="" ><?php echo ($userInfo['username']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">昵称：</div>
                                        <div class="bd"><input class="ui-txtin" type="text" value="<?php echo ($userInfo['username']); ?>" name="nikname"  /></div>
                                    </div>
                                    <?php if(empty($info['real_name'])): ?><div class="control-group">
                                            <div class="hd">真实姓名：</div>
                                            <div class="bd"><input class="ui-txtin" type="text" value="" name="real_name"  /></div>
                                        </div><?php endif; ?>
                                    <div class="control-group">
                                        <div class="hd">生日：</div>
                                        <div class="bd"><input class="ui-txtin" value="<?php echo ($info['birthday']); ?>" placeholder="请输入2017-01-01这样的格式哦~" type="text" name="birthday" id="birthday" /></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">性别：</div>
                                        <div class="bd">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="bd"><input class="ui-txtin" value="<?php echo ($info['address2']); ?>" type="text" name="address2"  /></div>
                                    </div>
