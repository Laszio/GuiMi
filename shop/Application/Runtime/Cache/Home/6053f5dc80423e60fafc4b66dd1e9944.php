                            ...
                            <!-- <form action="" enctype="multipart/form-data" method="post" id="testForm"> -->
                                ...
                                <div class="col-headpic">
                                    <div class="pic-wrap">
                                        ...
                                        <div class="picbox">
                                            <img src="/Uploads<?php echo ($detailInfo['user_img']); ?>" style="width:125px" alt="" />
                                        </div>
                                        <label>
                                ...
                                <div class="col-userinfo">
                                    <div class="control-group">
                                        ...
                                        <div class="bd"><a><?php echo ($userInfo['username']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">昵称：</div>
                                        <div class="bd"><a><?php echo ($userInfo['username']); ?></a></div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="bd"><a ><?php echo ($detailInfo['real_name']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">电话：</div>
                                        <div class="bd"><a ><?php echo ($userInfo['phone']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">生日：</div>
                                        <div class="bd"><a><?php echo ($detailInfo['birthday']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">性别：</div>
                                        <div class="bd"><a><?php echo ($detailInfo['sex']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">所在地：</div>
                                        <div class="bd"><a><?php echo ($detailInfo['address']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">详细地址：</div>
                                        <div class="bd"><a><?php echo ($detailInfo['address2']); ?></a></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="hd">邮箱：</div>
                                        <div class="bd">
                                            <div class="text-black"><?php echo ($userInfo['email']); ?><a class="edit-btn" href="editEmail">修改</a></div>
                                        </div>
                                    </div>
                                    <div class="control-submit">
                                        <div class="bd"><a href="<?php echo U('User/editInfo', ['id'=>$userInfo['id']]);?>" class="ui-btn-theme submit" >修改个人信息</a></div>
                                    </div>
                                </div>
                            <!-- </form> -->
                        </div>
...
<script>
    ...
    testForm.sf.onchange = function() {
        ...
        // 2.建立连接
        xhr.open('get', "/Home/User/getArea/id/"+val, true);
