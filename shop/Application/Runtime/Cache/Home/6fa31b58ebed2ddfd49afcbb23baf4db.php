            ...
            <div class="uc-content">
                <div class="uc-panel">
                    ...
                    <div class="uc-panel-bd">
                        <div class="uc-sort">
                            <div class="uc-tabs">
                                <a class="item active" href="<?php echo U('Order/allOrder');?>">所有订单（<?php echo ($waitOrderNum0); ?>）</a>
                                <a class="item " href="<?php echo U('Order/waitPay');?>">代付款（<?php echo ($waitOrderNum1); ?>）</a>
                                <a class="item " href="<?php echo U('Order/waitSend');?>">待发货（<?php echo ($waitOrderNum2); ?>）</a>
                        ...
                        <table class="uc-table">
                            ...
                            <tr class="order-goods">
                                ...
                                <td>
                                    <?php if($v['status'] == 1): ?><a href="/Home/Order/doPay/oid/<?php echo ($v['id']); ?>" class="ui-btn-theme uc-btn-md">完成支付</a>
                                    ...
                                    <?php elseif($v['status'] == 3): ?>
                                        <a href="<?php echo U('Order/orderDetail', ['oid'=>$v['id']]);?>"  class="ui-btn-theme uc-btn-md">订单详情</a>　
                                        <a href="javascript:;" val="<?php echo ($v['id']); ?> "  class="ui-btn-theme uc-btn-md lz-confirm">确认收货</a>
                                    <?php elseif($v['status'] == 4): ?>
                                        <a href="<?php echo U('Order/orderDetail', ['oid'=>$v['id']]);?>"  class="ui-btn-theme uc-btn-md">订单详情</a><?php endif; ?>
                                </td>
...
$('.lz-confirm').click(function() {
    ...
    $.ajax({
        type:'post',
        url:"<?php echo U('Order/confirmOrder');?>",
        data:'id='+val,
        success:function(res) {
            $('.lz-confirm').html('待评价');
            $('.lz-confirm').attr('href', "<?php echo U('Order/waitEvaluate');?>");
        }
    });
});
