                ...
                <div class="uc-panel">
                    ...
                    <div class="uc-panel-bd">
                        ...
                        <table class="uc-table">
                            <tr class="hd">
                                <?php if(empty($goodsList)): ?><td style="font-size:28px;">收藏夹为空</td>
                                <?php else: ?>
                                ...
                                <td width="120">操作</td>
                                <td><a href="" class="del iconfont icon-shanchu"></a></td><?php endif; ?>
                            </tr>
                            <!-- 收藏夹info -->
                            <?php if(is_array($goodsList)): foreach($goodsList as $key=>$goodsList): ?><tr class="fav-goods">
                                <td class="item">
                                    <img src="/Uploads<?php echo ($goodsList['pic1']); ?>" alt="" /><span class="name"><?php echo ($goodsList['gname']); ?></span>
                                </td>
                                <td><span class="text-theme fwb"><?php echo ($goodsList['price']*$goodsList['discount']/100); ?>元</span></td>
                                <?php if(($goodsList['status'] == 3) or ($goodsList['delsta'] == 2)): ?><td style="color: #7F7F7F;">商品已下架</td>
                                <?php else: ?>
                                    <td>现货</td><?php endif; ?>
                                <td>
                                    <a href="<?php echo U('Home/Goods/index/id/'.$goodsList['id']);?>" class="ui-btn-theme uc-btn-md mb5">查看详情</a><br />
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-warning" id="delfav" val="<?php echo ($goodsList['id']); ?>">删除</a>
                                </td>
