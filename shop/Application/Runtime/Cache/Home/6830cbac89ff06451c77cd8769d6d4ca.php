        ...
        <div class="uc-main clearfix">
            ...
            <div class="uc-content">
                <div class="uc-panel account-panel">
                    <div class="user-info">
                        <?php if(empty(session('userinfo.qq_openid'))): ?><a href=""><img class="headpic" src="/Uploads<?php echo ($detailInfo['user_img']); ?>" alt="头像" /></a>
                            <div class="info">
                                <div><span class="name"><?php echo session('userinfo.username');?></span><span class="wel">下午好</span></div>
                                <a href="" class="label">普通会员</a>
                        <?php else: ?>
                            <a href=""><img class="headpic" src="<?php echo ($detailInfo['user_img']); ?>" alt="头像" /></a>
                            <div class="info">
                                <div><span class="name"><?php echo session('userinfo.nikname');?></span><span class="wel">下午好</span></div>
                                <a href="" class="label">普通会员</a><?php endif; ?>
                            <a href="<?php echo U('User/editInfo', ['id'=>$_SESSION['userinfo']['id']]);?>" class="edit">修改个人信息></a>
                            </div>
                    </div>
                    <div class="quick-menu">
                        <div class="item">
                            <a href=""><img class="ico" src="/Public/Home/img/ico/uc-aq.png"/>账户安全：较高</a>
                        </div>
                        <div class="item">
                            <a href=""><img class="ico" src="/Public/Home/img/ico/uc-phone.png"/>绑定手机：<?php echo ($userInfo['phone']); ?></a>
                        </div>
                        <div class="item">
                            <a href=""><img class="ico" src="/Public/Home/img/ico/uc-dizhi.png"/>我的收货地址</a>
                        </div>
                        <div class="item">
                            <a href=""><img class="ico" src="/Public/Home/img/ico/uc-qianbao.png"/>我的钱包</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="uc-panel home-order">
                    <div class="col">
                        <img src="/Public/Home/img/ico/uc-order1.png" class="ico" />
                        <div class="bd">
                            <div class="tit">待支付的订单：<span class="num"><?php echo ($waitOrder); ?></span></div>
                            <a class="more" href="<?php echo U('Order/waitPay');?>">查看待支付订单></a>
                        </div>
                    </div>
                    <div class="col">
                        <img src="/Public/Home/img/ico/uc-order2.png" class="ico" />
                        <div class="bd">
                            <div class="tit">待发货的订单：<span class="num"><?php echo ($waitSendOrder); ?></span></div>
                            <a class="more" href="<?php echo U('Order/waitSend');?>">查看待发货的订单></a>
                        </div>
                    </div>
                    <div class="col">
                        <img src="/Public/Home/img/ico/uc-order3.png" class="ico" />
                        <div class="bd">
                            <div class="tit">待收货的订单：<span class="num"><?php echo ($waitGetOrder); ?></span></div>
                            <a class="more" href="<?php echo U('Order/waitGet');?>">查看待收货的订单></a>
                        </div>
                    </div>
                    <div class="col">
                        <img src="/Public/Home/img/ico/uc-order4.png" class="ico" />
                        <div class="bd">
                            <div class="tit">待评价的订单：<span class="num"><?php echo ($waitEvaluteOrder); ?></span></div>
                            <a class="more" href="<?php echo U('Order/waitEvaluate');?>">查看待评价的订单></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="uc-panel home-wuliu">
                    ...
                    <div class="home-wuliu-bd">
                        <div class="item">
                            ...
                            <div class="cont">
                                <img src="/Public/Home/uploads/3.jpg" alt="" class="figure" />
                                <div class="info">
