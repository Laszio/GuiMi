        ...
        <div class="cart-header wrapper">
            ...
            <div class="step-box">
                <div class="row">
                    ...
                    <div class="step active last col-3">
        ...
        <div class="pay-wrap">
            <div class="order-result">
                <div class="section clearfix">
                    ...
                    <div class="titbox">
                        <div class="tit">订单提交成功，已付金额 <?php echo ($totalMoney); ?> 元</div>
                        <div class="stit">订单号：<?php echo ($order['id']); ?></div>
                    </div>
                    <div class="mt20">
                        ...
                        <div class="meta">
                            ...
                            <div class="bd"><?= $order['address'].'('.$order['getman'].'收)　'.$order['phone']?><a href=''>个人中心</a></div>
                        </div>
                    </div>
                </div>
            </div>
