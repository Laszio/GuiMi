...
<article class="page-container">
	<form action="" id="<?php echo ($_GET['id']); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<?php if (!empty($_GET['name'])) :?>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>父类：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<?php echo trim($_GET['name']);?>
			</div>
		</div>
		<?php endif;?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea rows="13" cols="85" value="" placeholder="" id="ires" name="des"></textarea>
			</div>
		</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/Public/Admin/hui/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="/Public/Admin/hui/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="/Public/Admin/hui/lib/jquery.validation/1.14.0/messages_zh.js"></script>
